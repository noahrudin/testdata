...
.method protected addNotification(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-virtual {p0, p1, v1, p2}, Lcom/growthpush/handler/BaseReceiveHandler;->defaultNotificationBuilder(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
...
.method public builderWithNotificationChannel(Landroid/content/Context;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 7
    ...
    invoke-direct {v0, p1, v2}, Landroid/support/v4/app/NotificationCompat$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    return-object v0
.end method

.method public defaultNotificationBuilder(Landroid/content/Context;Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 1

    .line 104
    invoke-virtual {p0, p1}, Lcom/growthpush/handler/BaseReceiveHandler;->getBuilder(Landroid/content/Context;)Landroid/support/v4/app/NotificationCompat$Builder;

    move-result-object v0

    invoke-virtual {p0, v0, p1, p2, p3}, Lcom/growthpush/handler/BaseReceiveHandler;->defaultNotificationBuilder(Landroid/support/v4/app/NotificationCompat$Builder;Landroid/content/Context;Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
...
.method public defaultNotificationBuilder(Landroid/support/v4/app/NotificationCompat$Builder;Landroid/content/Context;Landroid/os/Bundle;Landroid/app/PendingIntent;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 9
    ...
    .line 120
    invoke-virtual {p1, v2}, Landroid/support/v4/app/NotificationCompat$Builder;->setTicker(Ljava/lang/CharSequence;)Landroid/support/v4/app/NotificationCompat$Builder;

    .line 121
    invoke-virtual {p1, v7}, Landroid/support/v4/app/NotificationCompat$Builder;->setSmallIcon(I)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 123
    invoke-virtual {v4, v2}, Landroid/support/v4/app/NotificationCompat$BigTextStyle;->setBigContentTitle(Ljava/lang/CharSequence;)Landroid/support/v4/app/NotificationCompat$BigTextStyle;
    ...
    invoke-virtual {p1, v1}, Landroid/support/v4/app/NotificationCompat$Builder;->setColor(I)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    .line 148
    invoke-virtual {p1, v4}, Landroid/support/v4/app/NotificationCompat$Builder;->setStyle(Landroid/support/v4/app/NotificationCompat$Style;)Landroid/support/v4/app/NotificationCompat$Builder;
    ...
    invoke-virtual {p1, p3, p4}, Landroid/support/v4/app/NotificationCompat$Builder;->setWhen(J)Landroid/support/v4/app/NotificationCompat$Builder;
...
.method public getBuilder(Landroid/content/Context;)Landroid/support/v4/app/NotificationCompat$Builder;
    .locals 2
    ...
    .line 169
    invoke-virtual {p0, p1}, Lcom/growthpush/handler/BaseReceiveHandler;->builderWithNotificationChannel(Landroid/content/Context;)Landroid/support/v4/app/NotificationCompat$Builder;
