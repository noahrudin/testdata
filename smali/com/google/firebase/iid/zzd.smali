...
.field private final zzr:Landroid/content/BroadcastReceiver$PendingResult;

.field private zzs:Z

.field private final zzt:Ljava/util/concurrent/ScheduledFuture;
...
.method constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/google/firebase/iid/zzd;->zzs:Z

    .line 3
    iput-object p1, p0, Lcom/google/firebase/iid/zzd;->intent:Landroid/content/Intent;

    .line 4
    iput-object p2, p0, Lcom/google/firebase/iid/zzd;->zzr:Landroid/content/BroadcastReceiver$PendingResult;
    ...
    iput-object p1, p0, Lcom/google/firebase/iid/zzd;->zzt:Ljava/util/concurrent/ScheduledFuture;
...
.method final declared-synchronized finish()V
    ...
    .line 8
    :try_start_0
    iget-boolean v0, p0, Lcom/google/firebase/iid/zzd;->zzs:Z

    if-nez v0, :cond_0

    .line 9
    iget-object v0, p0, Lcom/google/firebase/iid/zzd;->zzr:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    .line 10
    iget-object v0, p0, Lcom/google/firebase/iid/zzd;->zzt:Ljava/util/concurrent/ScheduledFuture;
